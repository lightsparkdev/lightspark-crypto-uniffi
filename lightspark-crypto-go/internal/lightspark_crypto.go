...
void ffi_lightspark_crypto_7bff_KeyPair_object_free(
	void* ptr,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_KeyPair_get_public_key(
	void* ptr,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_KeyPair_get_private_key(
	void* ptr,
	RustCallStatus* out_status
);

void ffi_lightspark_crypto_7bff_Mnemonic_object_free(
	void* ptr,
	RustCallStatus* out_status
);

void* lightspark_crypto_7bff_Mnemonic_random(
	RustCallStatus* out_status
);

void* lightspark_crypto_7bff_Mnemonic_from_entropy(
	RustBuffer entropy,
	RustCallStatus* out_status
);

void* lightspark_crypto_7bff_Mnemonic_from_phrase(
	RustBuffer phrase,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_Mnemonic_as_string(
	void* ptr,
	RustCallStatus* out_status
);

void ffi_lightspark_crypto_7bff_Seed_object_free(
	void* ptr,
	RustCallStatus* out_status
);

void* lightspark_crypto_7bff_Seed_new(
	RustBuffer seed,
	RustCallStatus* out_status
);

void* lightspark_crypto_7bff_Seed_from_mnemonic(
	void* mnemonic,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_Seed_as_bytes(
	void* ptr,
	RustCallStatus* out_status
);

void ffi_lightspark_crypto_7bff_InvoiceSignature_object_free(
	void* ptr,
	RustCallStatus* out_status
);

int32_t lightspark_crypto_7bff_InvoiceSignature_get_recovery_id(
	void* ptr,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_InvoiceSignature_get_signature(
	void* ptr,
	RustCallStatus* out_status
);

void ffi_lightspark_crypto_7bff_LightsparkSigner_object_free(
	void* ptr,
	RustCallStatus* out_status
);

void* lightspark_crypto_7bff_LightsparkSigner_new(
	void* seed,
	RustBuffer network,
	RustCallStatus* out_status
);

void* lightspark_crypto_7bff_LightsparkSigner_from_bytes(
	RustBuffer seed,
	RustBuffer network,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_LightsparkSigner_get_master_public_key(
	void* ptr,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_LightsparkSigner_derive_public_key(
	void* ptr,
	RustBuffer derivation_path,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_LightsparkSigner_derive_public_key_hex(
	void* ptr,
	RustBuffer derivation_path,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_LightsparkSigner_derive_private_key(
	void* ptr,
	RustBuffer derivation_path,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_LightsparkSigner_ecdh(
	void* ptr,
	RustBuffer public_key,
	RustCallStatus* out_status
);

void* lightspark_crypto_7bff_LightsparkSigner_sign_invoice(
	void* ptr,
	RustBuffer unsigned_invoice,
	RustCallStatus* out_status
);

void* lightspark_crypto_7bff_LightsparkSigner_sign_invoice_hash(
	void* ptr,
	RustBuffer unsigned_invoice,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_LightsparkSigner_derive_key_and_sign(
	void* ptr,
	RustBuffer message,
	RustBuffer derivation_path,
	int8_t is_raw,
...
RustBuffer lightspark_crypto_7bff_LightsparkSigner_get_per_commitment_point(
	void* ptr,
	RustBuffer derivation_path,
...
RustBuffer lightspark_crypto_7bff_LightsparkSigner_release_per_commitment_secret(
	void* ptr,
	RustBuffer derivation_path,
	uint64_t per_commitment_point_idx,
	RustCallStatus* out_status
...
RustBuffer lightspark_crypto_7bff_LightsparkSigner_generate_preimage_nonce(
	void* ptr,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_LightsparkSigner_generate_preimage(
	void* ptr,
	RustBuffer nonce,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_LightsparkSigner_generate_preimage_hash(
	void* ptr,
	RustBuffer nonce,
	RustCallStatus* out_status
);

void ffi_lightspark_crypto_7bff_Validation_init_callback(
	ForeignCallback callback_stub,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_sign_ecdsa(
	RustBuffer msg,
	RustBuffer private_key_bytes,
	RustCallStatus* out_status
);

int8_t lightspark_crypto_7bff_verify_ecdsa(
	RustBuffer msg,
...
RustBuffer lightspark_crypto_7bff_encrypt_ecies(
	RustBuffer msg,
	RustBuffer public_key_bytes,
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_decrypt_ecies(
	RustBuffer cipher_text,
	RustBuffer private_key_bytes,
	RustCallStatus* out_status
);

void* lightspark_crypto_7bff_generate_keypair(
	RustCallStatus* out_status
);

RustBuffer lightspark_crypto_7bff_handle_remote_signing_webhook_event(
...
RustBuffer ffi_lightspark_crypto_7bff_rustbuffer_alloc(
	int32_t size,
	RustCallStatus* out_status
);

RustBuffer ffi_lightspark_crypto_7bff_rustbuffer_from_bytes(
	ForeignBytes bytes,
	RustCallStatus* out_status
);

void ffi_lightspark_crypto_7bff_rustbuffer_free(
	RustBuffer buf,
	RustCallStatus* out_status
);

RustBuffer ffi_lightspark_crypto_7bff_rustbuffer_reserve(
	RustBuffer buf,
	int32_t additional,
	RustCallStatus* out_status
);
...
int32_t lightspark_crypto_7bff_cgo_Validation(uint64_t, int32_t, RustBuffer, RustBuffer *);
*/
import "C"
...
func (rb rustBuffer) free() {
	rustCall(func(status *C.RustCallStatus) bool {
		C.ffi_lightspark_crypto_7bff_rustbuffer_free(rb.self, status)
		return false
	})
}
...
func (_self *InvoiceSignature) GetRecoveryId() int32 {
	...
	return FfiConverterint32INSTANCE.lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.int32_t {
		return C.lightspark_crypto_7bff_InvoiceSignature_get_recovery_id(
...
func (_self *InvoiceSignature) GetSignature() []uint8 {
	...
	return FfiConverterSequenceuint8INSTANCE.lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_InvoiceSignature_get_signature(
			_pointer, _uniffiStatus)
	}))
	...
	result := &InvoiceSignature{
		newFfiObject(
			...
			func(pointer unsafe.Pointer, status *C.RustCallStatus) {
				C.ffi_lightspark_crypto_7bff_InvoiceSignature_object_free(pointer, status)
			}),
	}
...
func (_self *KeyPair) GetPublicKey() []uint8 {
	...
	return FfiConverterSequenceuint8INSTANCE.lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_KeyPair_get_public_key(
			_pointer, _uniffiStatus)
	}))
...
func (_self *KeyPair) GetPrivateKey() []uint8 {
	...
	return FfiConverterSequenceuint8INSTANCE.lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_KeyPair_get_private_key(
			_pointer, _uniffiStatus)
	}))
...
func (c FfiConverterKeyPair) lift(pointer unsafe.Pointer) *KeyPair {
	result := &KeyPair{
		newFfiObject(
			pointer,
			func(pointer unsafe.Pointer, status *C.RustCallStatus) {
				C.ffi_lightspark_crypto_7bff_KeyPair_object_free(pointer, status)
			}),
	}
...
func NewLightsparkSigner(seed *Seed, network Network) (*LightsparkSigner, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.lightspark_crypto_7bff_LightsparkSigner_new(FfiConverterSeedINSTANCE.lower(seed), FfiConverterTypeNetworkINSTANCE.lower(network), _uniffiStatus)
	})
	if _uniffiErr != nil {
...
func LightsparkSignerFromBytes(seed []uint8, network Network) (*LightsparkSigner, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.lightspark_crypto_7bff_LightsparkSigner_from_bytes(FfiConverterSequenceuint8INSTANCE.lower(seed), FfiConverterTypeNetworkINSTANCE.lower(network), _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue *LightsparkSigner
		return _uniffiDefaultValue, _uniffiErr
...
func (_self *LightsparkSigner) GetMasterPublicKey() (string, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_LightsparkSigner_get_master_public_key(
			_pointer, _uniffiStatus)
	})
	if _uniffiErr != nil {
...
func (_self *LightsparkSigner) DerivePublicKey(derivationPath string) (string, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_LightsparkSigner_derive_public_key(
...
func (_self *LightsparkSigner) DerivePublicKeyHex(derivationPath string) (string, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_LightsparkSigner_derive_public_key_hex(
			_pointer, FfiConverterstringINSTANCE.lower(derivationPath), _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue string
...
func (_self *LightsparkSigner) DerivePrivateKey(derivationPath string) (string, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_LightsparkSigner_derive_private_key(
			_pointer, FfiConverterstringINSTANCE.lower(derivationPath), _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue string
...
func (_self *LightsparkSigner) Ecdh(publicKey []uint8) ([]uint8, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_LightsparkSigner_ecdh(
...
func (_self *LightsparkSigner) SignInvoice(unsignedInvoice string) (*InvoiceSignature, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.lightspark_crypto_7bff_LightsparkSigner_sign_invoice(
...
func (_self *LightsparkSigner) SignInvoiceHash(unsignedInvoice []uint8) (*InvoiceSignature, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.lightspark_crypto_7bff_LightsparkSigner_sign_invoice_hash(
...
func (_self *LightsparkSigner) DeriveKeyAndSign(message []uint8, derivationPath string, isRaw bool, addTweak *[]uint8, mulTweak *[]uint8) ([]uint8, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_LightsparkSigner_derive_key_and_sign(
...
func (_self *LightsparkSigner) GetPerCommitmentPoint(derivationPath string, perCommitmentPointIdx uint64) ([]uint8, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_LightsparkSigner_get_per_commitment_point(
...
func (_self *LightsparkSigner) ReleasePerCommitmentSecret(derivationPath string, perCommitmentPointIdx uint64) ([]uint8, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_LightsparkSigner_release_per_commitment_secret(
			_pointer, FfiConverterstringINSTANCE.lower(derivationPath), FfiConverteruint64INSTANCE.lower(perCommitmentPointIdx), _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue []uint8
...
func (_self *LightsparkSigner) GeneratePreimageNonce() []uint8 {
	...
	return FfiConverterSequenceuint8INSTANCE.lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_LightsparkSigner_generate_preimage_nonce(
			_pointer, _uniffiStatus)
	}))
...
func (_self *LightsparkSigner) GeneratePreimage(nonce []uint8) ([]uint8, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_LightsparkSigner_generate_preimage(
...
func (_self *LightsparkSigner) GeneratePreimageHash(nonce []uint8) ([]uint8, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_LightsparkSigner_generate_preimage_hash(
			_pointer, FfiConverterSequenceuint8INSTANCE.lower(nonce), _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue []uint8
...
func (c FfiConverterLightsparkSigner) lift(pointer unsafe.Pointer) *LightsparkSigner {
	result := &LightsparkSigner{
		newFfiObject(
			pointer,
			func(pointer unsafe.Pointer, status *C.RustCallStatus) {
				C.ffi_lightspark_crypto_7bff_LightsparkSigner_object_free(pointer, status)
			}),
	}
...
func MnemonicRandom() (*Mnemonic, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.lightspark_crypto_7bff_Mnemonic_random(_uniffiStatus)
	})
	if _uniffiErr != nil {
...
func MnemonicFromEntropy(entropy []uint8) (*Mnemonic, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.lightspark_crypto_7bff_Mnemonic_from_entropy(FfiConverterSequenceuint8INSTANCE.lower(entropy), _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue *Mnemonic
		return _uniffiDefaultValue, _uniffiErr
...
func MnemonicFromPhrase(phrase string) (*Mnemonic, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeLightsparkSignerError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.lightspark_crypto_7bff_Mnemonic_from_phrase(FfiConverterstringINSTANCE.lower(phrase), _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue *Mnemonic
		return _uniffiDefaultValue, _uniffiErr
...
func (_self *Mnemonic) AsString() string {
	...
	return FfiConverterstringINSTANCE.lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_Mnemonic_as_string(
			_pointer, _uniffiStatus)
	}))
...
func (c FfiConverterMnemonic) lift(pointer unsafe.Pointer) *Mnemonic {
	result := &Mnemonic{
		newFfiObject(
			pointer,
			func(pointer unsafe.Pointer, status *C.RustCallStatus) {
				C.ffi_lightspark_crypto_7bff_Mnemonic_object_free(pointer, status)
			}),
	}
...
func NewSeed(seed []uint8) *Seed {
	...
	return FfiConverterSeedINSTANCE.lift(rustCall(func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.lightspark_crypto_7bff_Seed_new(FfiConverterSequenceuint8INSTANCE.lower(seed), _uniffiStatus)
	}))
...
func SeedFromMnemonic(mnemonic *Mnemonic) *Seed {
	...
	return FfiConverterSeedINSTANCE.lift(rustCall(func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.lightspark_crypto_7bff_Seed_from_mnemonic(FfiConverterMnemonicINSTANCE.lower(mnemonic), _uniffiStatus)
	}))
...
func (_self *Seed) AsBytes() []uint8 {
	...
	return FfiConverterSequenceuint8INSTANCE.lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_Seed_as_bytes(
			_pointer, _uniffiStatus)
	}))
...
func (c FfiConverterSeed) lift(pointer unsafe.Pointer) *Seed {
	result := &Seed{
		newFfiObject(
			pointer,
			func(pointer unsafe.Pointer, status *C.RustCallStatus) {
				C.ffi_lightspark_crypto_7bff_Seed_object_free(pointer, status)
			}),
	}
...
//export lightspark_crypto_7bff_cgo_Validation
func lightspark_crypto_7bff_cgo_Validation(handle C.uint64_t, method C.int32_t, args C.RustBuffer, outBuf *C.RustBuffer) C.int32_t {
...
func (c *FfiConverterTypeValidation) register() {
	rustCall(func(status *C.RustCallStatus) int32 {
		C.ffi_lightspark_crypto_7bff_Validation_init_callback(C.ForeignCallback(C.lightspark_crypto_7bff_cgo_Validation), status)
		return 0
	})
}
...
func SignEcdsa(msg []uint8, privateKeyBytes []uint8) ([]uint8, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeCryptoError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_sign_ecdsa(FfiConverterSequenceuint8INSTANCE.lower(msg), FfiConverterSequenceuint8INSTANCE.lower(privateKeyBytes), _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue []uint8
		return _uniffiDefaultValue, _uniffiErr
...
func VerifyEcdsa(msg []uint8, signatureBytes []uint8, publicKeyBytes []uint8) (bool, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeCryptoError{}, func(_uniffiStatus *C.RustCallStatus) C.int8_t {
		return C.lightspark_crypto_7bff_verify_ecdsa(FfiConverterSequenceuint8INSTANCE.lower(msg), FfiConverterSequenceuint8INSTANCE.lower(signatureBytes), FfiConverterSequenceuint8INSTANCE.lower(publicKeyBytes), _uniffiStatus)
	})
	if _uniffiErr != nil {
...
func EncryptEcies(msg []uint8, publicKeyBytes []uint8) ([]uint8, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeCryptoError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_encrypt_ecies(FfiConverterSequenceuint8INSTANCE.lower(msg), FfiConverterSequenceuint8INSTANCE.lower(publicKeyBytes), _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue []uint8
		return _uniffiDefaultValue, _uniffiErr
...
func DecryptEcies(cipherText []uint8, privateKeyBytes []uint8) ([]uint8, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeCryptoError{}, func(_uniffiStatus *C.RustCallStatus) C.RustBuffer {
		return C.lightspark_crypto_7bff_decrypt_ecies(FfiConverterSequenceuint8INSTANCE.lower(cipherText), FfiConverterSequenceuint8INSTANCE.lower(privateKeyBytes), _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue []uint8
		return _uniffiDefaultValue, _uniffiErr
...
func GenerateKeypair() (*KeyPair, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeCryptoError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.lightspark_crypto_7bff_generate_keypair(_uniffiStatus)
	})
	if _uniffiErr != nil {
